...
%%
    ...
    function group_stim_order = generate_stim_order(experiment_version, group_number)
    %%
    ...
    %%
        ...
        version = repmat(experiment_version, height(group_stim_order), 1);
        group_stim_order = [table(version), group_stim_order];
    end
end
